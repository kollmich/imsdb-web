...
aws-assets:
	aws s3 sync dev s3://trendspotting.site/2020/April/movies --delete --cache-control 'max-age=31536000' --exclude 'index.html' --exclude 'bundle.js'

aws-htmljs:
	aws s3 cp dev/index.html s3://trendspotting.site/2020/April/movies/index.html
	aws s3 cp dev/bundle.js s3://trendspotting.site/2020/April/movies/bundle.js
